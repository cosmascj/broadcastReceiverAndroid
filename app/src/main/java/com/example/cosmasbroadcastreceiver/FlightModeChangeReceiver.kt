package com.example.cosmasbroadcastreceiver
...
class FlightModeChangeReceiver : BroadcastReceiver() {

    // this function will be excecuted when the user changes his to flight mode
